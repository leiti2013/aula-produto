...
public class ConnectionFactory {
    ...
    public static ConnectionFactory build(){
        ...
        try {
            ...
            System.err.println("Deu ruim, paizão (Não conseguimos encontrar o arquivo de propriedades: " + e.getMessage() + ")");
        } catch (IOException e) {
            System.err.println("Deu ruim, paizão (Não conseguimos ler o arquivo de propriedades com o nome: " + e.getMessage() + ")");
        } finally {
            if(Objects.nonNull(debugar) && debugar.equals("true")){
